...
2. Fill `management/HUMAN_REVIEW_GATES.md` and use `management/APPROVALS.md` to record required human decisions.
3. Fill `research/` when reference research is required, or record an explicit waiver.
4. Fill `product/PRD.md`.
5. Fill `product/MVP.md`.
6. Fill `product/ROADMAP.md` and `product/USER_STORIES.md` as needed.
7. Fill `architecture/SYSTEM_DESIGN.md` for approved MVP scope.
...
12. Record review and validation in task-local `review.md`, task-local `test.md`, and `management/VALIDATION_STATUS.md`.
...
| `management/` | Human review gates, approvals, master plan, task board, blockers, status, changelog, and validation status. |
