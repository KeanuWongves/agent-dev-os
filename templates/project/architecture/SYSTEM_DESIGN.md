...
Approval rule: architecture artifacts may be drafted before approval, but implementation planning must not treat this design as approved until Gate 3 approval or waiver is recorded in `management/APPROVALS.md` and linked above.
